...
1. Написание автотестов: 12 - 14 часов
...
1. Авто-тесты будут готовы 10.10.2022
1. Баг-репорты и отчёт по результатам тестов: 27.10.2022
1. Отчёт по результатам автоматизации: 28.10.2022